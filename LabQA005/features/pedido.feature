...
Funcionalidade: Pedidos
    ...
    Como um usuário do site Starbugs, eu quero selecionar e compra cafés
    Para que eu possa receber os produtos em meu endereço e efetuar o pagamento no Cartão de Débito
